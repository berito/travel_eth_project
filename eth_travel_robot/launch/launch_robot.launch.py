...
def generate_launch_description():
  ...
  start_city_cmd = DeclareLaunchArgument(
            'user_input',
            default_value='AddisAbaba',
            description='Start City default(AddisAbaba)')
